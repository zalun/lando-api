...
from landoapi.api.revisions import _build_reviewers, _create_commit_message
...
def test_build_reviewers_reviewers_and_users_doesnt_match():
...
def test_commit_message_for_multiple_reviewers():
    reviewers = [{'username': 'reviewer_one'}, {'username': 'reviewer_two'}]
    commit_message = _create_commit_message('A title.', 1, reviewers)
